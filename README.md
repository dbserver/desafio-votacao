...
- Cadastrar uma nova documento
- Abrir uma sessão de votação em uma documento (a sessão de votação deve ficar aberta por
  um tempo determinado na chamada de abertura ou 1 minuto por default)
- Receber votos dos associados em pautas (os votos são apenas 'Sim'/'Não'. Cada associado
  é identificado por um id único e pode votar apenas uma vez por documento)
- Contabilizar os votos e dar o resultado da votação na documento
...
// CPF Ok para votar
{
    "statusDocumento": "ABLE_TO_VOTE
}
// CPF Nao Ok para votar - retornar 404 no client tb
{
    "statusDocumento": "UNABLE_TO_VOTE
}
```
