...
class VotosPautaParaVotosPautaDTOMapperSpec extends Specification {
    ...
    com.dbserver.desafio.valida.cpf.usecase.domain.VotosPauta votosPautaRequerida
    ...
    def setup() {
        ...
        votosPautaRequerida = Fixture.from(com.dbserver.desafio.valida.cpf.usecase.domain.VotosPauta).gimme(VOTOS_PAUTA_PAUTA)
    }
