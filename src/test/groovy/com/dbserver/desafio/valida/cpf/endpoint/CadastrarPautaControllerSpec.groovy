...
class CadastrarPautaControllerSpec extends Specification {
    ...
    com.dbserver.desafio.valida.cpf.usecase.domain.Pauta pautaVazioRequerida
    ...
    def setup() {
        ...
        pautaMock = Fixture.from(com.dbserver.desafio.valida.cpf.usecase.domain.Pauta).gimme(PAUTA_OBRA)
        ...
        pautaVazioRequerida = Fixture.from(com.dbserver.desafio.valida.cpf.usecase.domain.Pauta).gimme(PAUTA_VAZIO)
    }
