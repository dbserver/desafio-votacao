...
class VotoEntityParaVotoMapperSpec extends Specification {
    ...
    com.dbserver.desafio.valida.cpf.usecase.domain.Voto votoSemSessaoMock
    com.dbserver.desafio.valida.cpf.usecase.domain.Voto votoSemPautaMock
    List<com.dbserver.desafio.valida.cpf.usecase.domain.Voto> votoListMock
    ...
    def setup() {
        ...
        votoSemSessaoMock = Fixture.from(com.dbserver.desafio.valida.cpf.usecase.domain.Voto).gimme(VOTO_PAUTA)
        votoSemPautaMock = Fixture.from(com.dbserver.desafio.valida.cpf.usecase.domain.Voto).gimme(VOTO_PAUTA_SEM_PAUTA)
        votoListMock = List.of(Fixture.from(com.dbserver.desafio.valida.cpf.usecase.domain.Voto).gimme(VOTO_PAUTA_COM_SESSAO))
    }
    ...
    def "Deveria converter um objeto VotoEntity valido em um objeto Voto"() {
        ...
        com.dbserver.desafio.valida.cpf.usecase.domain.Voto votoResultado = VotoEntityParaVotoMapper.INSTANCE.map(votoEntityRequerida)
    ...
    def "Deveria converter um objeto VotoEntity sem sessao valido em um objeto Voto sem sessao"() {
        ...
        when: "quando o metodo map do Voto for invocado"
        com.dbserver.desafio.valida.cpf.usecase.domain.Voto votoResultado = VotoEntityParaVotoMapper.INSTANCE.map(votoEntitySemSessaoRequerida)
    ...
    def "Deveria converter um objeto VotoEntity sem pauta valido em um objeto Voto sem pauta"() {
        ...
        when: "quando o metodo map do Voto for invocado"
        com.dbserver.desafio.valida.cpf.usecase.domain.Voto votoResultado = VotoEntityParaVotoMapper.INSTANCE.map(votoEntitySemPautaRequerida)
    ...
    def "Deveria converter uma lista de VotoEntity valido em uma lista de Voto"() {
        ...
        when: "quando o metodo map do Voto for invocado"
        List<com.dbserver.desafio.valida.cpf.usecase.domain.Voto> votoListResultado = VotoEntityParaVotoMapper.INSTANCE.mapList(votoEntityListRequerida)
