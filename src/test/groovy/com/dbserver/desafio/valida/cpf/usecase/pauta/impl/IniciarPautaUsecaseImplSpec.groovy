...
class IniciarPautaUsecaseImplSpec extends Specification {
    ...
    com.dbserver.desafio.valida.cpf.usecase.sessao.IniciarSessaoUsecase iniciarSessaoUsecase = Mock()

    SalvarPautaUsecase salvarPautaUsecase = Mock()

    com.dbserver.desafio.valida.cpf.usecase.pauta.IniciarPautaUsecase iniciarPautaUsecase
    ...
    def "Deveria validar uma chamada com sucesso ao metodo execute da classe IniciarPautaUsecaseImpl "() {
        ...
        com.dbserver.desafio.valida.cpf.usecase.domain.Pauta pautaResultado = iniciarPautaUsecase.execute(pautaDuracaoDTORequerida.idPauta,
