...
//import br.tec.db.desafio.business.service.implementation.validacao.pauta.IValidacaoPautaRequest;
...
//    @Mock
//    List<IValidacaoPautaRequest> validacoesPauta;
//    private static final String ASSUNTO = "tema da pauta";
//
//    @Test
//    void devePersistirPautaComSucesso() {
//        PautaService pautaServiceImpl = new PautaService(pautaRepository,validacoesPauta, validacoesEntity);
//
